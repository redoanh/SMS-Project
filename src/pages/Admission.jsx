...
function Admission() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Detailed Admission Form Data:", formData);
    setSubmitted(true);
  };
        ...
        {submitted ? (
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600 max-w-[500px] mx-auto mb-8 leading-relaxed">
              আপনার বিস্তারিত আবেদনটি ফ্রন্টএন্ড স্টেটে সফলভাবে সংরক্ষিত হয়েছে। ব্যাকএন্ড এপিআই যুক্ত করার পর এটি সরাসরি ডাটাবেসে চলে যাবে।
            </p>
            <div className="flex justify-center gap-4">
              <button onClick={() => setSubmitted(false)} className="bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-2.5 rounded-lg font-bold shadow-md cursor-pointer transition">
                Apply Another
              </button>
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-8">
            ...
            <div>
              ...
              <div className="mb-4">
                <label className="block text-sm font-bold text-gray-700 mb-2">Is the student fresh in Class 1 or has a previous school? *</label>
                <div className="flex gap-6">
                  <label className="flex items-center gap-2 cursor-pointer font-medium text-gray-700">
                    <input type="radio" name="isNewStudent" value="Yes" checked={formData.isNewStudent === 'Yes'} onChange={handleChange} />
                    Fresh Admission (No Previous School)
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer font-medium text-gray-700">
                    <input type="radio" name="isNewStudent" value="No" checked={formData.isNewStudent === 'No'} onChange={handleChange} />
              ...
              {formData.isNewStudent === 'No' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200 animate-fadeIn">
                  <div>
